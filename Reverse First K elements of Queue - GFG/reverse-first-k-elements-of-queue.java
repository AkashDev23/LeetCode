...
class GfG {
    ...
    public Queue<Integer> modifyQueue(Queue<Integer> q, int k) {
        // This is same as reversing a Queue but only till an element k
        // We will make a stack then add the elements till k into that stack then pop elements one by one this will reverse the queue. 
